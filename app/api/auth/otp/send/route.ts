...
export async function POST(request: Request) {
  try {
    ...
    const payload: { success: true; message: string; debugOtp?: string; smsError?: string } = {
      success: true,
    ...
    try {
      ...
      payload.message = "OTP generated. SMS delivery failed, so use the debug OTP in development.";
      payload.debugOtp = otp;
      payload.smsError = smsError;
    }
